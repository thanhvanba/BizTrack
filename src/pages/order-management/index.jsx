...
const OrderManagement = () => {
  ...
  const [ordersData, setOrdersData] = useState([
    {
      ...
      shipping_address: "123 Đường Lê Lợi, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh",
    ...
    },
    {
      ...
      shipping_address: "456 Đường Nguyễn Huệ, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh",
    ...
    },
    {
      ...
      shipping_address: "789 Đường Lý Tự Trọng, Phường Bến Thành, Quận 1, TP. Hồ Chí Minh",
    ...
    },
    {
      ...
      items: 1,
      order_status: "Đã giao",
      shipping_address: "101 Đường Hai Bà Trưng, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh",
    ...
    },
    {
      ...
      items: 2,
      order_status: "Đã hủy",
      shipping_address: "202 Đường Đồng Khởi, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh",
      payment_method: "Chuyển khoản",
  ...
  const handleEditOrder = (updatedOrder) => {
    ...
    // Close modal and show success message
    setEditModalVisible(false)
    message.success(`Đơn hàng ${updatedOrder.order_code} đã được cập nhật thành công!`)
  }
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "order_date",
      sorter: (a, b) =>
        new Date(a.order_date.split("/").reverse().join("-")) - new Date(b.order_date.split("/").reverse().join("-")),
      responsive: ["md"],
    },
    {
      title: "Tổng tiền",
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="small">
          ...
          <Tooltip title="In hóa đơn">
            <Button type="text" icon={<PrinterOutlined />} size="small" className="hover:bg-gray-100" />
          </Tooltip>
          <Tooltip title="Tải xuống">
            <Button type="text" icon={<DownloadOutlined />} size="small" className="hover:bg-gray-100" />
          </Tooltip>
        </Space>
      ),
    },
