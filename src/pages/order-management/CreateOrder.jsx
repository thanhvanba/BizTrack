...
const CreateOrderPage = () => {
    ...
    const handleCreateOrder = async () => {
        try {
            ...
            const formattedOrderDate = moment(values.order_date).format(
                "YYYY-MM-DD"
            );
        ...
        <div className="relative">
                ...
                <div className="grid grid-cols-3 gap-4 mb-10 pb-10">
                    ...
                    <div className="col-span-2 bg-white p-4 rounded-lg shadow space-y-2">
                        <Descriptions column={4} size="small" bordered>
                            <Descriptions.Item label="Tổng số tiền" className="font-medium !text-xl" span={4}>
                                <div style={{ textAlign: 'right' }}>{formatCurrency(calculateTotalAmount())}</div>
                            </Descriptions.Item>

                            <Descriptions.Item label="Giảm giá theo đơn hàng" span={2}>
                                <div style={{ textAlign: 'right' }}>{formatCurrency(orderDiscount)}</div>
                            </Descriptions.Item>

                            <Descriptions.Item label="Giảm giá theo từng sản phẩm" span={2}>
                                <div style={{ textAlign: 'right' }}>{formatCurrency(calculateDiscountAmount() - orderDiscount)}</div>
                            </Descriptions.Item>

                            <Descriptions.Item label="Tổng giảm giá" style={{ color: "green" }} span={4}>
                            ...
                            <Descriptions.Item label="Sau giảm giá" span={4}>
                                <div style={{ textAlign: 'right' }}>{formatCurrency(calculateFinalAmount())}</div>
                            </Descriptions.Item>
                            ...
                            <Descriptions.Item label="Đã thanh toán" span={4}>
                                <div style={{ textAlign: 'right' }}>{formatCurrency(transferAmount)}</div>
                            </Descriptions.Item>

                            <Descriptions.Item label="Còn thiếu" span={4} style={{ color: "red" }}>
                                <div style={{ textAlign: 'right' }}>
                                    <strong>{formatCurrency(calculateFinalAmount() - transferAmount)}</strong>
                                </div>
                            </Descriptions.Item>
                        </Descriptions>
            ...
            >
                ...
                <div>
                    ...
                    <div>
                        <Text style={{ color: "red" }}>COD: {formatCurrency(calculateFinalAmount() - transferAmount)}</Text>
                    </div>
                </div>
