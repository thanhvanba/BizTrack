...
const RevenueTracking = () => {
  ...
  useEffect(() => {
    const handelGetDataRevenue = async () => {
      ...
      const res1 = await analysisService.getTopCustomers()
      console.log("🚀 ~ handelGetDataRevenue ~ res1:", res1)
      const ress33 = await analysisService.getFinancialStatistics({ type: "day", year: 2025, month: 8 })
